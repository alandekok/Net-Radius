# This Makefile is for the Net::Radius extension to perl.
#
...
#	NAME => q[Net::Radius]
#	PM => { Net/Radius/Dictionary.pm=>q[$(INST_LIBDIR)/Net/Radius/Dictionary.pm], Net/Radius/Packet.pm=>q[$(INST_LIBDIR)/Net/Radius/Packet.pm] }
#	VERSION_FROM => q[version.pl]
...
EXPORT_LIST = Radius.def

PERL_ARCHIVE = $(PERL_INC)\perl56.lib

TO_INST_PM = Net/Radius/Dictionary.pm \
	Net/Radius/Packet.pm

PM_TO_BLIB = Net/Radius/Dictionary.pm \
	$(INST_LIBDIR)/Net/Radius/Dictionary.pm \
	Net/Radius/Packet.pm \
	$(INST_LIBDIR)/Net/Radius/Packet.pm
...
Radius.def: Makefile.PL
	$(PERL) "-I$(PERL_ARCHLIB)" "-I$(PERL_LIB)" -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME' => 'Net::Radius', 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
realclean purge ::  clean
	...
	$(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::Command -e rm_f $(INST_LIBDIR)/Net/Radius/Dictionary.pm $(INST_LIBDIR)/Net/Radius/Packet.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Net-Radius\" VERSION=\"1,3,0,0\">\n}. qq{\t<TITLE>Net-Radius</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"MSWin32-x86-multi-thread\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Net-Radius.ppd
